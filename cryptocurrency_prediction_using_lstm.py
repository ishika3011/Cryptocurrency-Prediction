# -*- coding: utf-8 -*-
"""Cryptocurrency_prediction_using_LSTM.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1anLFe_kel59hPMGjVgQwjbT0yeHV3PF3
"""
...
#Same model but EPOCHs value updated
valid_data=final_dataset[987:,:]  
...
lstm_model1.fit(x_train_data,y_train_data,epochs=4,batch_size=1,verbose=2)
inputs_data=new_dataset[len(new_dataset)-len(valid_data)-60:].values
inputs_data=inputs_data.reshape(-1,1)
inputs_data=scaler.transform(inputs_data)
